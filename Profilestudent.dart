...
class Profilestudent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ProliestudentPage();
  }
}

class ProliestudentPage extends StatefulWidget {
  const ProliestudentPage({
    Key? key,
  }) : super(key: key);

  @override
  State<ProliestudentPage> createState() => _ProliestudentPageState();
}

class _ProliestudentPageState extends State<ProliestudentPage> {
